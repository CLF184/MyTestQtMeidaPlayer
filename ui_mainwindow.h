...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        musiclist->setGeometry(QRect(10, 210, 111, 175));
        ...
        playlist->setGeometry(QRect(10, 0, 111, 175));
        layoutWidget2 = new QWidget(centralwidget);
        layoutWidget2->setObjectName("layoutWidget2");
        layoutWidget2->setGeometry(QRect(10, 180, 118, 20));
        ...
        layoutWidget4->setGeometry(QRect(10, 390, 118, 20));
